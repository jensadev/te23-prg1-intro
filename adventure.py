...
# Vid lökning finns det en 50% chans att du hittar något spännande ["vättejos", "kantarell", "ekorre", "sten"]
...
# Om du möter en person och är smittad av vätte så kan du bita personen och förvandla dem till en vätte, -10 poäng
